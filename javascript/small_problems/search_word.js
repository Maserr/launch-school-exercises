// Write a function that takes a word and text as inputs and returns the number
...
function searchWord(word, text) {
  ...
  return words.reduce(function(count, currentWord) {
    if (currentWord === word) {
      return count += 1;
    }
...
var empty = '';
searchWord('foo', empty); // 0

var foo = 'Foo!';
searchWord('', foo);      // 0

var loremIpsum = 'Lorem ipsum dolor sit amet, lorem ipsum-dolor sit amet.';
searchWord('et', loremIpsum);     // 0
searchWord('lorem', loremIpsum);  // 2
searchWord('amet', loremIpsum);   // 2
searchWord('ipsum', loremIpsum);  // 1
