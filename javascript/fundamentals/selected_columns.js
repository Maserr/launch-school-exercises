...
// new array. Currently, it is not producing the expected behavior. Go over the
// function and the sample runs. What do you think is the problem?
...
// The problem is that in the second `for` loop the value of the variable
// `length` is reassigned.
