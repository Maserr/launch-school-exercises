...
# remainder of the collection (including the element that resulted in a falsey
# return) to an Array, and returns the result.
#
# Write a method called drop_while that behaves similarly for Arrays. It should
# take an Array as an argument, and a block. It should return all of the
...
def drop_while(array)
  result = []
  array.each { |item| result << item unless yield(item) }
  result
end
